  ...
  return (
    <div className="p-4 bg-white rounded">
        ...
        <div className="flex items-center justify-between mt-2">
            ...
            <button className={`bg-blue-500 text-white text-sm rounded py-2 px-6 font-semibold ${disable && "bg-blue-300 cursor-not-allowed"}`} onClick={createPost}>create post 😎</button>
        </div>
    </div>
  )
}
